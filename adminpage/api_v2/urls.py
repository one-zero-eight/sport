...
urlpatterns.extend([
    ...
    path('openapi_v2.json', SpectacularJSONAPIView.as_view(), name='schema'),
    path('openapi_v2.yaml', SpectacularYAMLAPIView.as_view(), name='schema-yaml'),
    ...
    re_path(
        ...
        RedirectView.as_view(url="/api/openapi_v2.json"),
        name='redirect-to-schema'
    ),
    re_path(
        r'swagger(?P<format>\.yaml)$',
        RedirectView.as_view(url="/api/openapi_v2.yaml"),
